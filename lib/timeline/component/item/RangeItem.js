 ...
 */
  ...
  _updateDirtyDomComponents() {
    ...
    if (this.dirty) {
      ...
      if (this.parent.itemSet.options.mode === 'vertical') {
        this.dom.box.className = this.dom.box.className + " vis-vertical";
      }
  ...
  repositionX(limitSize) {
    ...
    if (this.parent.itemSet.options.mode === 'vertical') {
      this.dom.box.style.transform = `translateY(${this.left}px)`;
    }
    else {
      if (this.options.rtl) {
    ...
    if (this.parent.itemSet.options.mode === 'vertical') {
      this.dom.box.style.height = `${boxWidth}px`;
      this.dom.content.style.height = '100%';

      this.dom.box.style.width = '100%';
    ...
    switch (align) {
      case 'left':
        if (this.parent.itemSet.options.mode === 'vertical') {
          this.dom.content.style.transform = 'translateY(0)';
        }
        else {
      ...
      case 'right':
        if (this.parent.itemSet.options.mode === 'vertical') {
          this.dom.content.style.transform = `translateY(${Math.max((boxWidth - contentWidth), 0)}px)`;
        }
        else {
          if (this.options.rtl) {
      ...
      case 'center':
        if (this.parent.itemSet.options.mode === 'vertical') {
          this.dom.content.style.transform = `translateY(${Math.max((boxWidth - contentWidth) / 2, 0)}px)`;
        }
        else {
          if (this.options.rtl) {
      ...
      default: // 'auto'
        ...
        if (this.parent.itemSet.options.mode === 'vertical') {
          this.dom.content.style.transform = `translateY(${contentStartPosition}px)`;
        }
        else {
          if (this.options.rtl) {
